...
const HomePage = () =>
{
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center">
      <div className="w-fit mt-32 p-4 lg:my-12">
        <h1 className="text-4xl font-bold text-white type-welcome hidden lg:block"></h1>
      </div>
      <Card className='w-full lg:w-1/2 h-fit flex flex-col justify-center items-center p-4'>
