...
export type PaginationHookProps = {
  siblingCount?: number
} & Pick<PaginatedList<unknown>, 'page' | 'limit' | 'total'>
...
export const usePagination = (props: PaginationHookProps) => {
  return useMemo(() => {
    ...
    */
    ...
    const rightSiblingIndex = Math.min(props.page + siblingCount, totalPageCount)
    ...
    */
    ...
    // }
  }, [props.total, props.limit, props.siblingCount, props.page])
}
