...
import {
  SingleDay,
  getDaysOfMonth,
  getQuickNavigationMonthItems,
  getQuickNavigationYearItems,
} from "./Helper";
import MonthHeader from "./MonthHeader";
import { isSameMonth } from "date-fns";
import QuickNavigationView, {
  QuickNavigationItem,
} from "./QuickNavigationView";
...
export default function DatePicker(props: DatePickerProps) {
  ...
  const [quickNavigationItems, setQuickNavigationItems] = useState<
    QuickNavigationItem[]
  >([]);
